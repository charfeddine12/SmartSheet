    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="page-header">
                    ...
                    <p>Fill the below information to add a Client</p>

                </div>

              <form:form action="${pageContext.request.contextPath}/admin/addClient" method="post" commandName="client" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                      ...
                      <form:input id="employeImage" path="cli_img" type="file" class="form:input-large"/>
                  </div>
                  <br><br>
